...
SELECT CONCAT('Dr. Sample ', LPAD(n, 2, '0')),
       CASE n % 5 WHEN 0 THEN 'Dermatology' WHEN 1 THEN 'Cardiology'
            WHEN 2 THEN 'Neurology' WHEN 3 THEN 'Orthopedics' ELSE 'Pediatrics' END,
...
FROM doctor
CROSS JOIN (
    SELECT '09:00-10:00' AS available_times
    UNION ALL SELECT '10:00-11:00'
    UNION ALL SELECT '14:00-15:00'
    UNION ALL SELECT '15:00-16:00'
) AS slots
